                        ...
                        <!-- left column -->
                            <div class="box">
                                ...
                                <ul class="nav nav-tabs" id="myTab">
                                      ...
                                      <li><a href="clearance.php"  >Approved</a></li>
                                      <li><a data-target="#disapproved" data-toggle="tab">Disapproved</a></li>
                                       <li class="active"><a data-target="#approved" data-toggle="tab" class="notification">Issue Clearance
                                    <span class="badge"> <?php
                                            $q = mysqli_query($con,"SELECT * from tblclearance where isRead = 1 ");
                                            $num_rows = mysqli_num_rows($q);
                                            echo $num_rows;
                                        ?></span>
                                      </a></li>
                                        ...
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                if(!isset($_SESSION['staff']))
                                                {
                                                    ...
                                                    $squery = mysqli_query($con, "SELECT *,CONCAT(r.lname, ', ' ,r.fname, ' ' ,r.mname) as residentname,p.id as pid FROM tblclearance p left join tblresident r on r.id = p.residentid  where isRead = 1") or die('Error: ' . mysqli_error($con));
