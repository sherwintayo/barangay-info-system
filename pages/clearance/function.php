...
if(isset($_POST['btn_approve']))
{
    ...
    $approve_query = mysqli_query($con,"UPDATE tblclearance set clearanceNo= '".$txt_cnum."', findings = '".$txt_findings."', orNo = '".$txt_ornum."', samount = '".$txt_amount."', status='Approved', isRead=1 where id = '".$txt_id."' ") or die('Error: ' . mysqli_error($con));
...
if(isset($_POST['btn_save']))
{
    ...
    $update_query = mysqli_query($con,"UPDATE tblclearance set clearanceNo= '".$txt_edit_cnum."', findings = '".$txt_edit_findings."', orNo = '".$txt_edit_ornum."', samount = '".$txt_edit_amount."', isRead=0 where id = '".$txt_id."' ") or die('Error: ' . mysqli_error($con));
