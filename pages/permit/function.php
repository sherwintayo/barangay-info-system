...
if(isset($_POST['btn_approve']))
{
    ...
    $approve_query = mysqli_query($con,"UPDATE tblpermit set orNo = '".$txt_ornum."', samount = '".$txt_amount."',status = 'Approved', isRead=1  where id = '".$txt_id."' ") or die('Error: ' . mysqli_error($con));
