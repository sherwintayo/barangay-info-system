                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-user-plus" aria-hidden="true"></i>Issue Permit</button>  
                                        <?php 
                                ...
                                <ul class="nav nav-tabs" id="myTab">
                                        ...
                                        <li><a href="permit.php">Approved</a></li>
                                      <li><a data-target="#disapproved" data-toggle="tab">Disapproved</a></li>
                                       <li class="active"><a data-target="#approved" data-toggle="tab" class="notification">Issue Permit
                                          <span class="badge"> <?php
                                            $q = mysqli_query($con,"SELECT * from tblpermit where isRead = 1 ");
                                            $num_rows = mysqli_num_rows($q);
                                            echo $num_rows;
                                        ?></span>
                                      </a></li>
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                $squery = mysqli_query($con, "SELECT *,CONCAT(r.lname, ', ' ,r.fname, ' ' ,r.mname) as residentname,p.id as pid FROM tblpermit p left join tblresident r on r.id = p.residentid where isRead=1") or die('Error: ' . mysqli_error($con));
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                       ...
                                                       <button class="btn btn-primary btn-xs" data-target="#editModal'.$row['pid'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
                                                        <a  href="print.php?resident='.$row['residentid'].'&permit='.$row['businessName'].'&val='.sha1($row['businessName'].'|'.$row['businessAddress'].'|'.$row['dateRecorded']).'" onclick="location.reload();" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-print" aria-hidden="true"></i>Print</a> 
                            ...
                            <div class="box">
                                ...
                                <form method="post">
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT *,CONCAT(r.lname, ', ' ,r.fname, ' ' ,r.mname) as residentname,p.id as pid FROM tblpermit p left join tblresident r on r.id = p.residentid where p.status = 'New'") or die('Error: ' . mysqli_error($con));
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                echo '
                                                <tr>
