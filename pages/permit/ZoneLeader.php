            ...
            <form method="post">
                <table id="table" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $squery = mysqli_query($con, "SELECT *, CONCAT(r.lname, ', ' ,r.fname, ' ' ,r.mname) as residentname, p.id as pid FROM tblpermit p LEFT JOIN tblresident r ON r.id = p.residentid WHERE p.status = 'New' AND r.barangay = '$barangay'") or die('Error: ' . mysqli_error($con));
