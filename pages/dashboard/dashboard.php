          ...
          <div class="row">
            ...
            <div class="box">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12"><br>
                <div class="info-box">
                  <a href="../household/household.php"><span class="info-box-icon" style="background-color: #0000FF;"><i
              ...
              <div class="col-md-3 col-sm-6 col-xs-12"><br>
                <div class="info-box">
                  <a href="../resident/resident.php"><span class="info-box-icon" style="background-color: #0000FF;"><i
              ...
              <div class="col-md-3 col-sm-6 col-xs-12"><br>
                <div class="info-box">
                  <a href="../resident/newResident.php"><span class="info-box-icon" style="background-color: #0000FF;"><i
                        class="fa fa-users"></i></span></a>
                  <div class="info-box-content">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12"><br>
                <div class="info-box">
                  <a href="../clearance/clearance.php"><span class="info-box-icon" style="background-color: #0000FF;"><i
              ...
              <div class="col-md-3 col-sm-6 col-xs-12"><br>
                <div class="info-box">
                  <a href="../permit/permit.php"><span class="info-box-icon" style="background-color: #0000FF;"><i
                        class="fa fa-file"></i></span></a>
                  <div class="info-box-content">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12"><br>
                <div class="info-box">
                  <a href="../blotter/blotter.php"><span class="info-box-icon" style="background-color: #0000FF;"><i
