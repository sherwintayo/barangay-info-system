                                ...
                                <div class="box-header">
                                    ...
                                    <div class="info-box-content"
                                        ...
                                        <span class="info-box-number" style="text-align: center;">
                                            <?php
                                            if ($isZoneLeader) {
                                                $q = mysqli_query($con, "SELECT * from tblresident where statRes=0 AND status = 'InActive' AND barangay = '$zone_barangay'");
                                            }else{
                                        ...
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                if (!isset($_SESSION['staff'])) {
                                                    ...
                                                    $squery = mysqli_query($con, "SELECT *,zone,id,CONCAT(lname, ', ', fname, ' ', mname) as cname, age, gender, formerAddress, image FROM tblresident WHERE status = 'InActive' order by zone");
                                                    while ($row = mysqli_fetch_array($squery)) {
                                                        echo '
                                                    <tr>
                                                        <td>' . $row['zone'] . '</td>
